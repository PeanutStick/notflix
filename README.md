...
> Watch his video on this - [bugswriter's notflix](https://youtu.be/RFJCL9C46Mc) <3
...
```sh
$ sudo curl -sL "https://raw.githubusercontent.com/PeanutStick/notflix/master/notflix" -o /usr/local/bin/notflix
